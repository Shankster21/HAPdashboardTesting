...
curs.execute("select *  from filelib.haptempsv2 where hc_site_name = 'Dallas Center'")
rows = curs.fetchall()

curs.execute("select distinct hc_bin_code from filelib.haptempsv2 where hc_site_name = 'Dallas Center' order by hc_bin_code ")
bins = curs.fetchall()

curs.execute("select distinct hc_read_date from filelib.haptempsv2 where hc_site_name = 'Dallas Center'")
dates = curs.fetchall()

# curs.execute("select distinct hc_read_date from filelib.haptempsv2 where hc_site_name = 'Dallas Center' and hc_read_date = '{}'").formate(today)
# todayDate = curs.fetchall()

curs.execute("select distinct hc_bin_code from filelib.haptempsv2 where hc_site_name = 'Dallas Center'")
HAPbins = curs.fetchall()

curs.execute("select distinct gb_bcbin, gb_capacity, gb_bushels_in_bin, gb_bin_will_hold, gb_commodity_code, gb_measure_date from filelib.getbinclct where  gb_location = '31' order by gb_bcbin ")
binMeasurements = curs.fetchall()

# curs.execute("select distinct hc_bin_code from filelib.haptempsv2 where hc_site_name = 'Dallas Center' and avgf > '80' and hc_read_date = '2020-08-08'")
# hotBins = curs.fetchall()

# _________ WRITE HTML FILE ________
with open('DallasCenterHomePROD.html','w') as file:

# HTML page head info stuff
    file.write('''<!doctype html><html lang="en"><head><title>Dallas Center Home Page</title><meta charset="utf-8"><meta name="description" content="The HTML5 Herald"><meta name="author" content="SitePoint"><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script><script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <link rel="stylesheet" type="text/css" href="DallasCenterHome.css"><script src="DallasCenterHome.js"></script>\n</head>\n\n''')
...
# header
    file.write('''<header>
         ...
         <div class="row no-gutters">
              ...
              <div class="col-5 col2">
                   <div id = "locationInfo">
                             <p> Location Number: 31 </p>
                           <p> Functional Unit: 9 </p>

                   </div>
                   <!-- <div id = "diagram">
                   <img src="dallasCenterDiagram.pdf" > -->
    ...
    file.write('''<a class="weatherwidget-io" href="https://forecast7.com/en/41d68n93d96/dallas-center/?unit=us" data-label_1="DALLAS CENTER" data-label_2="WEATHER" data-theme="original" >DALLAS CENTER WEATHER</a>
<script>
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
</script>\n\n ''')

    #file.write('''<div class = "documentBox"> </div>  ''')
...
<!-- BIN NUMBER COLUMN  -->
                        <td>
                            <button type="button" class="tableButton" data-toggle="modal" data-target="#modal''')
        file.write(str(i))
        file.write('''" id = "binNumButton''')
        file.write(str(i))
        file.write('''">''')
        file.write('''      <script>
...
# HAP COLUMN
        ...
        file.write('''].bin == HAPbins[j] ){
                            document.write(' <button type="button" class="tableButton" id = "viewButton''')
        file.write(str(i) + ''' " ''' )
        file.write('''onclick = "openHAPWindow(BinOrderPOS''')
        file.write(str(i))
        file.write('''); "> View </button>')\n''')
...
#         file.write('''].bin)"> <br>'); \n''')
#         file.write('''
#                             document.write('<div class = "binRoof"></div><div class = "bin"><div class = "ch6">6</div> <div class = "ch14">14</div><div class = "ch7">7</div><div class = "ch5">5</div><div class = "ch13">13</div><div class = "ch1">1</div><div class = "ch4">4</div><div class = "ch2">2</div><div class = "ch12">12</div><div class = "ch8">8</div><div class = "ch13">13</div><div class = "ch11">11</div><div class = "ch10">10</div><div class = "ch9">9</div> '); \n''')
#
...
#         for i in reversed(range(209,225)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#         for i in reversed(range(97,113)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#         for i in reversed(range(193,209)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#         for i in reversed(range(177,193)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#         for i in reversed(range(113,129)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#
#         file.write('''
#                             document.write('<div class = "c9">''')
#         for i in reversed(range(129,145)):
#             file.write('''<div class = "cs''')
#             file.write(str(i))
#             file.write('''"> - </div>''')
#         file.write('''"</div>''')
...
#
    ...
    file.write('     <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous"></script> \n ')
    file.write('     <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script> \n\n ')
    file.write('</body>  \n')
    file.write('</html>  \n')

# ________ WRITE JAVASCRIPT FILE ________
with open('DallasCenterHome.js','w') as file:
...
# changes sensor color
    ...
    file.write('   var temp95_ruby = 95;\n')
    file.write('   var temp90_crimson = 90;\n')
    ...
    for i in range(224):
        ...
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#ffbbd9"; }\n''')
        file.write('    }\n')
        ...
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#fe9cc4"; }\n''')
        file.write('    }\n')
        ...
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#92278d"; }\n''')
        file.write('    }\n')
        ...
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#652f92"; }\n''')
        file.write('    }\n')
        ...
        file.write('    else if (sensor[')
        file.write(str(i))
        file.write('] <= temp90_crimson){ \n')
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#d90000"; }\n''')
        file.write('    }\n')

        file.write('    else if (sensor[')
        file.write(str(i))
        file.write('] <= temp95_ruby){ \n')
        file.write('''          const x = document.getElementsByClassName("cs''')
        file.write(str(i+1) + '''");\n''')
        file.write('''          for (let e of x) { e.style.background = "#9b0000"; }\n''')
        file.write('    }\n')
...
# function that resents the bin graph back to empty
    ...
    file.write('''function openHAPWindow(POS){\n''')
    file.write('''    var popupWindow = window.open("file:///Z:/locationManagment/locationDashboards/DallasCenter/hapBin.html" ,"popup","width=600,height=600");\n''')
    file.write('''window.binPOS = POS;\n ''')
    file.write('''}\n\n''')

    file.write('''function selectBin(){\n''')
    # file.write('''alert(window.binPOS);\n ''')
    file.write('''document.getElementById("HAp").innerHTML = "POS" ;\n''')
    file.write('''}\n\n''')
